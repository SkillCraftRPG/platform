...
namespace SkillCraft.Cms.PostgreSQL.Migrations
{
    ...
    [Migration("20260520183855_AlterMarkerKeyLength")]
    partial class AlterMarkerKeyLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SkillCraft.Cms.Infrastructure.Entities.ArticleMapEntity", b =>
                {
                    b.Property<int>("ArticleId")
                        .HasColumnType("integer");
                    ...
                    b.Property<Guid>("MapUid")
                        .HasColumnType("uuid");

                    b.HasKey("ArticleId", "MapId");
                    ...
                    b.ToTable("ArticleMaps", "Encyclopedia");
                });
            ...
            modelBuilder.Entity("SkillCraft.Cms.Infrastructure.Entities.MapEntity", b =>
                {
                    b.Property<int>("MapId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("Maps", "Encyclopedia");
                });

            modelBuilder.Entity("SkillCraft.Cms.Infrastructure.Entities.MarkerEntity", b =>
                {
                    b.Property<int>("MarkerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("MarkerId"));
                    ...
                    b.ToTable("Markers", "Encyclopedia");
                });
            ...
            modelBuilder.Entity("SkillCraft.Cms.Infrastructure.Entities.ArticleMapEntity", b =>
                {
                    ...
                    b.HasOne("SkillCraft.Cms.Infrastructure.Entities.MapEntity", "Map")
                        .WithMany("Articles")
                        .HasForeignKey("MapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
