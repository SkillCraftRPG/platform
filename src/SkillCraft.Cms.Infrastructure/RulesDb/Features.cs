...
internal static class Features
{
  ...
  public static readonly ColumnId HtmlContent = new(nameof(FeatureEntity.HtmlContent), Table);
  ...
  public static readonly ColumnId Key = new(nameof(FeatureEntity.Key), Table);
  public static readonly ColumnId KeyNormalized = new(nameof(FeatureEntity.KeyNormalized), Table);
