...
internal static class Talents
{
  ...
  public static readonly ColumnId HtmlContent = new(nameof(TalentEntity.HtmlContent), Table);
  ...
  public static readonly ColumnId MetaDescription = new(nameof(TalentEntity.MetaDescription), Table);
