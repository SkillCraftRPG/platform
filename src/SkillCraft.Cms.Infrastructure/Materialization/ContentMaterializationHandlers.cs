...
internal class ContentMaterializationHandlers : IEventHandler<ContentLocalePublished>, IEventHandler<ContentLocaleUnpublished>
{
  public static void Register(IServiceCollection services)
  {
    ...
    services.AddTransient<ICommandHandler<PublishMapCommand, Unit>, PublishMapCommandHandler>();
    services.AddTransient<ICommandHandler<PublishMarkerCommand, Unit>, PublishMarkerCommandHandler>();
    ...
    services.AddTransient<ICommandHandler<UnpublishMapCommand, Unit>, UnpublishMapCommandHandler>();
    services.AddTransient<ICommandHandler<UnpublishMarkerCommand, Unit>, UnpublishMarkerCommandHandler>();
    ...
    try
    {
      ...
      switch (kind)
      {
        ...
        case EntityKind.Collection:
          await _commandBus.ExecuteAsync(new PublishCollectionCommand(@event, published.Invariant, published.Locale), cancellationToken);
          break;
        ...
        case EntityKind.Language:
          ...
          break;
        case EntityKind.Map:
          await _commandBus.ExecuteAsync(new PublishMapCommand(@event, published.Invariant, published.Locale), cancellationToken);
          break;
        case EntityKind.Marker:
          await _commandBus.ExecuteAsync(new PublishMarkerCommand(@event, published.Invariant, published.Locale), cancellationToken);
          break;
        ...
        case EntityKind.QuestGroup:
          ...
          break;
        case EntityKind.QuestLog:
          await _commandBus.ExecuteAsync(new PublishQuestLogCommand(@event, published.Invariant, published.Locale), cancellationToken);
          break;
        ...
        case EntityKind.Spell:
          ...
          break;
        case EntityKind.SpellCategory:
          await _commandBus.ExecuteAsync(new PublishSpellCategoryCommand(@event, published.Invariant, published.Locale), cancellationToken);
          break;
    ...
    try
    {
      ...
      switch (kind)
      {
        ...
        case EntityKind.Language:
          ...
          break;
        case EntityKind.Map:
          await _commandBus.ExecuteAsync(new UnpublishMapCommand(@event), cancellationToken);
          break;
        case EntityKind.Marker:
          await _commandBus.ExecuteAsync(new UnpublishMarkerCommand(@event), cancellationToken);
          break;
        case EntityKind.Quest:
        ...
        case EntityKind.QuestGroup:
          ...
          break;
        case EntityKind.QuestLog:
          await _commandBus.ExecuteAsync(new UnpublishQuestLogCommand(@event), cancellationToken);
          break;
        case EntityKind.Script:
        ...
        case EntityKind.Spell:
          ...
          break;
        case EntityKind.SpellCategory:
          await _commandBus.ExecuteAsync(new UnpublishSpellCategoryCommand(@event), cancellationToken);
          break;
        case EntityKind.SpellEffect:
