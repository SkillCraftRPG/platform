...
internal class LineageFeatureEntity
{
  ...
  public override bool Equals(object? obj) => obj is LineageFeatureEntity entity && entity.LineageId == LineageId && entity.FeatureId == FeatureId;
  public override int GetHashCode() => HashCode.Combine(LineageId, FeatureId);
  public override string ToString() => $"{GetType()} (LineageId={LineageId}, FeatureId={FeatureId})";
}
